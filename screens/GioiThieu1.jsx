...
const GioiThieu1 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Hình ảnh */}
      <Image
        source={require("../assets/gioithieu1.png")} // Đường dẫn tới hình ảnh của bạn
        style={styles.image}
      />
      ...
      <Text style={styles.description}>
        Lưu trữ ý tưởng, thông tin quan trọng và kế hoạch một cách dễ dàng.
      </Text>

      {/* Nút "Tiếp tục" */}
      <TouchableOpacity
        style={styles.continueButton}
        onPress={() => navigation.navigate("GioiThieu2")}
      >
